...
<?php if ( ! $is_legacy ) : ?>
        <input
                ...
                value="inpbut_end"
                class="has_img"
                data-showfor="gfsp_toggle gfsp_ios gfsp_dot gfsp_flip gfsp_draw gfsp_default"
                data-hidefor=""
            >
            <label for="cb_inpbut_end" class="img_icn" data-hover="Move input at the end">
                <span class="dir_ltr"><?php self::icn_img("list-inpbut-end.svg") ?></span>
                <span class="dir_rtl"><?php self::icn_img("list-inpbut-end-rtl.svg") ?></span>
            </label>
<?php endif; ?>
        ...
        <input id="gfsp_o_frame-tickanim-mid" class="has_img" type="radio" name="gfsp_o_style" value="gfsp_o_frame o-custom-bg o-ticktopright o-tickover o-notick">
            <label for="gfsp_o_frame-tickanim-mid" data-hover="Tick middle"><?php self::icn_img("o_frame_tickmid.png"); ?></label>
