...
jQuery("[name=gfsp_o_style]").on("change", function() {
    ...
    jQuery(".gfsp_effects_wrapper input, input#cb_inpbut_end").each( function(i, e) {
...
function gfspChoicesObserve(fld){
    ...
    var observer = new MutationObserver(function(mutations) {
      mutations.forEach(function(mutation) {
        ...
        var oAfter = (field[WLSettingName] !== undefined && field[WLSettingName].indexOf('o_after') > -1);
        jQuery(mutation.addedNodes).each( function(){
            ...
            if (field.choices !== "" && field.choices[index].spOrnament != undefined && field.choices[index].spOrnament != '') {
                ...
                var ornamentArr = field.choices[index].spOrnament.split('|');
                var ornament = "";
